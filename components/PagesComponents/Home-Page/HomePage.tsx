...
const MobileMode = () => {
  return (
    ...
    >
      <div className="container mx-auto flex min-h-screen w-full flex-col md:flex-row justify-between items-center md:py-20">
        <div className="mt-6 mb-2 md:order-2 flex md:hidden ">
          <SocilaMedia display="justify-center flex" />
        </div>
        <div className="px-16 my-4 md:order-3 md:my-0 md:w-4/12 md:p-10">
          <Avatar />
        </div>
        ...
        <div className="mt-4 mb-5 md:order-4 md:w-4/12">
          <Email />
        </div>
      </div>
    </section>
