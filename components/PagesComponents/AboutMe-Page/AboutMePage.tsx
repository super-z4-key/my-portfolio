...
const AboutMePage = () => {
  ...
  return (
    ...
    >
      <div className="container mx-auto min-h-screen py-4 w-[98%] md:w-[90%] flex justify-center items-center">
        <div className="flex flex-col md:flex-row justify-center items-center p-1 gap-2">
          <div className="w-[70%] md:w-6/12 flex justify-center items-center box-border">
            <Image
              src={AvatarIcons}
              alt="image"
              className="md:p-20 m-4 md:m-10"
            />
          </div>
